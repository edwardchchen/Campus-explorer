...
export default class RoomQueryTransformationHelper {
	...
	public transformAllQuery (validateHelper: ValidateHelper, filteredDataset: Room[], query: any): any[] {
		...
		dataSetTransform = this.transformApply(dataSetTransform, validateHelper.dataSetField,
	...
	public multipleGroupByArray(dataArray: Room[], groupPropertyArray: string[]): any[][]{ // type correct?
